...
//        }
        ...
        Benchmark_Timer<String[]> timer_r=new Benchmark_Timer<>("Benchmarking",null,(x)->lsd.sort(x,0,x.length-1),null);
//        Benchmark_Timer<Integer[]> timer_r2=new Benchmark_Timer<>("Benchmarking",null,(x)->lsd.sort(x,0,x.length),null);
...
//        Benchmark_Timer<Integer[]> timer_r4=new Benchmark_Timer<>("Benchmarking",null,(x)->ins.sort(x,0,x.length),null);
        Supplier sup_reverse=() -> convertedNames;
...
//        Supplier sup_partial=() -> array_partial;
        ...
        System.out.println("When n is "+n+" mean time is "+time_reverse+" for LSD");
//        System.out.println();
